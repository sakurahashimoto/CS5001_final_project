...
# #you can store multiple lists such as study list, personal list etc at once
# #!!!!!!unused!!!!!!!
# class Task:
#     def __init__(self, name, due_date, tag, time_estimate):
#         self.name = name
...
if __name__ == "__main__":
    app = TaskApp("/tmp/cs5001_tasklist.json")
    app.run()
